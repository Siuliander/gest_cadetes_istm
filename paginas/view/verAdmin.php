...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles">Dados do <small> Administrador</small></h1>
    </div>
</div>
          ...
          <div class="form-group">
			...
			<?php if(@$linha): ?>
			  ...
			  <div class="col-sm-12">
				<div class="form-group">
						<div class="col-sm-4">
							<label>Nível:</label> <?php echo (@$linha) ? $linha->nivel : NULL; ?>
						</div>
					</div>
					<hr>
				</div>
			...
			?>
				...
				<?php if(@$linha): ?>
					<div class="col-sm-6 col col-xs-6 text-right"> 
					  <a href='<?php echo '?pg='.CodificarTexto('formadmin').'&id='.ProtegeTexto(base64_encode(@$linha-> id_admin)); ?>&btn=<?php echo CodificarTexto('editar');?>'>
