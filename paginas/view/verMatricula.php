...
<?php
	...
	if( @$id != NULL):
        $result = BuscarMatriculados($id , null , NULL, $admin = NULL, $conexao);
...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles">Dados da <small> Matrícula</small></h1>
    </div>
</div>
          ...
          <div class="form-group">
			...
			<?php if(@$linha): ?>
			  ...
			  <div class="col-sm-12">
				<div class="form-group">
						...
						<div class="col-sm-4">
							<label>Ano:</label> <?php echo (@$linha) ? $linha->ano : NULL; ?>
						</div>
						<div class="col-sm-4">
							<label>Turma:</label> <?php echo (@$linha) ? $linha->turma : NULL; ?>
						</div>
					</div>
					<hr>
				</div>
			...
			?>
			 	...
			 	<div class="col-sm-6 col col-xs-6 text-left">
				  <a href='?pg=<?php echo CodificarTexto('viewmatriculas');?>'>
